function showTime() {
    ...
    var startDate = new Date(2018, 3, 31);
    ...
    if (seconds < 10)
        seconds = "0" + seconds;
    var currentTimeString = "Dear Aoruola:<br>" +
        ...
        "<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----灵豪   2019-02-01</c>";
